              ...
              <div>
                ...
                <div style={{ fontSize: '0.9rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  <div>
                    ...
                    <strong style={{color: 'var(--success)'}}>₹{selectedCsr.available_budget?.toLocaleString() || selectedCsr.budget.toLocaleString()}</strong>
                  </div>
                  <div>
                    <span style={{ color: 'var(--text-muted)' }}>Allocated to Projects: </span>
                    <strong>₹{(selectedCsr.available_budget - selectedCsr.budget_remaining).toLocaleString()}</strong>
                  </div>
                  <div>
